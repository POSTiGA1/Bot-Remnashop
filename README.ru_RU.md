...
- **🔔 Уведомления**
    ...
    > Системные уведомления: жизненный цикл бота, регистрация, оформление подписки, активация промокода, статус узла, первое подключение пользователя, добавление/удаление устройства пользователя.
...
> **Важно**: Не удаляйте файл `default.jpg` — он необходим для корректной работы.
...
> **Важно**: на данный момент обновления переводов при апдейте бота не сохраняются.  
> При обновлении ваши предыдущие ассеты будут архивированы в: `/opt/remnashop/assets_backup/`
